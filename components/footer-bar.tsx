...
export function Footerbar() {
  return (
    <footer className="p-5 sm:p-5 relative">
      <div className="mx-auto max-w-screen-2xl">
          ...
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-left text-sm font-light whitespace-nowrap dark:text-white">
                  {siteConfig.slogan}
                </span>
              </div>
            </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            {siteConfig.copyrights.trademake} {siteConfig.copyrights.yearIssued}{" "}
            <a href="/" className="hover:underline">
              {siteConfig.copyrights.name}™
            </a>
            . {siteConfig.copyrights.declaration}
          </span>
